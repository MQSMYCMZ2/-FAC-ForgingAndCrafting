...
public class GoldStarUpgradeSwordItem extends SwordItem {
    public GoldStarUpgradeSwordItem() {
        super(new Tier() {
            @Override
            public int getUses() {
                return 4090;
    ...
    public void inventoryTick(ItemStack itemStack, Level world, Entity entity, int slot, boolean selected) {
        ...
        if (selected) {
            if (entity instanceof LivingEntity livingEntity && !livingEntity.level.isClientSide()) {
                ...
                if (mainHandItem.getItem() == ForgingAndCraftingItems.GOLD_STAR_UPGRADE_SWORD.get()) {
